...
// 1) model에 세팅된 값의 key와 {}값이 같으면 세션 스코프로 등록
// 2) session에 올려둔 값을 해당 클래스에서 얻어와 사용할 수 있게 함 -> @SessionAttribute("키값")으로 사용
public class MyPageController {
	...
	public String updateProfile(@RequestParam("profileImage") MultipartFile profileImage, //업로드 파일
		...
		// 1. 웹 접근 경로
		String webPath = "/resources/images/member/"; // 실제로 이미지 파일이 저장되어야 하는 서버 컴퓨터 경로
